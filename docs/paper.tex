...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\textwidth}
        ...
        \centering
        \includegraphics[width=0.9\textwidth]{bayesian_network_trimmed.png}
    \end{minipage}
